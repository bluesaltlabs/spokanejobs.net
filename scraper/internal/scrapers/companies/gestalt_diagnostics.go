...
type GestaltDiagnosticsScraper struct {
	*types.BaseScraper
}

func NewGestaltDiagnosticsScraper() *GestaltDiagnosticsScraper {
	return &GestaltDiagnosticsScraper{
		BaseScraper: &types.BaseScraper{
			Name:         "gestalt_diagnostics",
			ScheduleHour: 7,
			Config: types.ScraperConfig{
				BaseURL: "https://gestaltdiagnostics.com/careers/",
			},
		},
	}
}
