...
type SynergisticitScraper struct {
	*types.BaseScraper
}

func NewSynergisticitScraper() *SynergisticitScraper {
	return &SynergisticitScraper{
		BaseScraper: &types.BaseScraper{
			Name:         "synergisticit",
			ScheduleHour: 1,
			Config: types.ScraperConfig{
				BaseURL: "https://www.synergisticit.com/careers/",
			},
		},
	}
}

func (scraper *SynergisticitScraper) ScrapeJobs() []types.ScrapedJob {
...
func (scraper *SynergisticitScraper) GetName() string {
	return scraper.Name
}

func (scraper *SynergisticitScraper) ScrapedJobs() []types.ScrapedJob {
...
func (scraper *SynergisticitScraper) ScrapeJobDetails(job *types.ScrapedJob) {
	// Default implementation - can be overridden if needed
}

func (scraper *SynergisticitScraper) SaveOutput(outputDir string) error {
