...
type ProvidenceScraper struct {
	*types.BaseScraper
}

func NewProvidenceScraper() *ProvidenceScraper {
	return &ProvidenceScraper{
		BaseScraper: &types.BaseScraper{
			Name:         "providence",
			ScheduleHour: 17,
			Config: types.ScraperConfig{
				BaseURL: "https://www.providence.org/careers",
			},
		},
	}
}

func (scraper *ProvidenceScraper) ScrapeJobs() []types.ScrapedJob {
...
func (scraper *ProvidenceScraper) GetName() string {
	return scraper.Name
}

func (scraper *ProvidenceScraper) ScrapedJobs() []types.ScrapedJob {
...
func (scraper *ProvidenceScraper) ScrapeJobDetails(job *types.ScrapedJob) {
	// Default implementation - can be overridden if needed
}

func (scraper *ProvidenceScraper) SaveOutput(outputDir string) error {
