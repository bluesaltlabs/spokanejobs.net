...
func ScrapeJobs() []models.ScrapedJob {
	...
	scrapeUrl := "https://careers.smartrecruiters.com/GravityJack"


	// Create the new collector
	c := colly.NewCollector(
		colly.AllowedDomains("linkding.bluesaltlabs.com", "bluesaltlabs.com", "careers.smartrecruiters.com"),
